...
export const ALL_QUESTIONS: Question[] = [
  ...
  // ═══════════════════════════════════════════════
  // PROGRAMME DES GRADES — TECHNIQUES  (pg01–pg20)
  // ═══════════════════════════════════════════════

  // — Ceinture Blanche-Jaune —
  {
    id: 'pg01',
    text: '🟡⬜ Ceinture blanche-jaune — "Tai Otoshi" se traduit par :',
    options: ['Grand fauchage extérieur', 'Grande hanche', 'Renversement du corps par barrage', 'Projection par-dessus l\'épaule'],
    correctIndex: 2,
    explanation: 'Tai Otoshi = "renversement du corps par barrage". Tori bloque la jambe adverse (barrage) et utilise une rotation du corps pour projeter Uke.',
    category: Category.GRADES_CLUB,
    level: Level.DEBUTANT,
  },
  {
    id: 'pg02',
    text: '🟡⬜ Ceinture blanche-jaune — "Kesa Gatame" désigne :',
    options: ['Un balayage de pied', 'Un contrôle en travers (immobilisation)', 'Une projection en cercle', 'Un étranglement en triangle'],
    correctIndex: 1,
    explanation: 'Kesa Gatame = "contrôle en travers". Tori immobilise Uke en se plaçant à son côté, en contrôlant le bras et la tête. C\'est la première immobilisation enseignée.',
    category: Category.GRADES_CLUB,
    level: Level.DEBUTANT,
  },
  {
    id: 'pg03',
    text: '🟡⬜ Ceinture blanche-jaune — Quelle est la traduction de "O Uchi Gari" ?',
    options: ['Petit fauchage intérieur', 'Grand fauchage extérieur', 'Grand fauchage intérieur', 'Petit fauchage extérieur'],
    correctIndex: 2,
    explanation: 'O Uchi Gari = "grand fauchage intérieur". O = grand, Uchi = intérieur, Gari = fauchage. La jambe de Tori fauche l\'intérieur de la jambe d\'Uke vers l\'arrière.',
    category: Category.GRADES_CLUB,
    level: Level.DEBUTANT,
  },
  ...
  {
    id: 'pg04',
    text: '🟡 Ceinture jaune — "O Soto Gari" se traduit par :',
    options: ['Grand fauchage intérieur', 'Petit fauchage extérieur', 'Grand renversement extérieur', 'Grand fauchage extérieur'],
    correctIndex: 3,
    explanation: 'O Soto Gari = "grand fauchage extérieur". O = grand, Soto = extérieur, Gari = fauchage. Tori fauche la jambe d\'Uke par l\'extérieur en projetant vers l\'arrière.',
    category: Category.GRADES_CLUB,
    level: Level.DEBUTANT,
  },
  {
    id: 'pg05',
    text: '🟡 Ceinture jaune — Quelle technique signifie littéralement "Grande Hanche" ?',
    options: ['Seoi Otoshi', 'Sasae Tsuri Komi Ashi', 'O Goshi', 'O Soto Otoshi'],
    correctIndex: 2,
    explanation: 'O Goshi = "grande hanche". O = grand, Goshi/Koshi = hanche. Tori passe la hanche sous le centre de gravité d\'Uke pour le projeter. C\'est l\'une des premières techniques de hanche (Koshi Waza).',
    category: Category.GRADES_CLUB,
    level: Level.DEBUTANT,
  },
  ...
  {
    id: 'pg06',
    text: '🟠🟡 Ceinture jaune-orange — "De Ashi Barai" signifie :',
    options: ['Balayage des deux pieds', 'Blocage du pied en tirant', 'Balayage du pied avancé', 'Accrochage du pied extérieur'],
    correctIndex: 2,
    explanation: 'De Ashi Barai = "balayage du pied avancé". De = avancer, Ashi = pied/jambe, Barai = balayage. Tori balaie le pied d\'Uke au moment où il avance, avant qu\'il ne se pose.',
    category: Category.GRADES_CLUB,
    level: Level.DEBUTANT,
  },
  {
    id: 'pg07',
    text: '🟠🟡 Ceinture jaune-orange — "Uki Goshi" se traduit par :',
    options: ['Hanche tirée', 'Hanche flottée', 'Hanche balayée', 'Hanche sautée'],
    correctIndex: 1,
    explanation: 'Uki Goshi = "hanche flottée". Uki = flotter, Goshi = hanche. Contrairement à O Goshi, Tori ne passe pas complètement la hanche sous Uke, d\'où l\'effet de "flottement".',
    category: Category.GRADES_CLUB,
    level: Level.INTERMEDIAIRE,
  },
  ...
  {
    id: 'pg08',
    text: '🟠 Ceinture orange — "Uchi Mata" se traduit par :',
    options: ['Grand fauchage intérieur', 'Fauchage par l\'intérieur de la cuisse', 'Roue autour du genou', 'Hanche balayée'],
    correctIndex: 1,
    explanation: 'Uchi Mata = "fauchage par l\'intérieur de la cuisse". Uchi = intérieur, Mata = cuisse/entrejambe. La jambe de Tori fauche l\'intérieur de la cuisse d\'Uke vers le haut.',
    category: Category.GRADES_CLUB,
    level: Level.INTERMEDIAIRE,
  },
  {
    id: 'pg09',
    text: '🟠 Ceinture orange — Que signifie "Tsubame Gaeshi" ?',
    options: ['La projection en cercle', 'Le retour de l\'hirondelle', 'La hanche sautée', 'La roue autour de la jambe'],
    correctIndex: 1,
    explanation: 'Tsubame Gaeshi = "le retour de l\'hirondelle". C\'est une contre-attaque : quand Uke tente un balayage de pied (De Ashi Barai), Tori relève sa jambe et riposte avec le même balayage.',
    category: Category.GRADES_CLUB,
    level: Level.INTERMEDIAIRE,
  },
  ...
  {
    id: 'pg10',
    text: '🟢🟠 Ceinture orange-verte — "Hane Goshi" signifie :',
    options: ['Hanche tirée', 'Hanche flottée', 'Hanche sautée', 'Hanche balayée'],
    correctIndex: 2,
    explanation: 'Hane Goshi = "hanche sautée". Hane = sauter/rebondir, Goshi = hanche. Tori propulse Uke en donnant une impulsion (rebond) de la jambe sous la cuisse adverse.',
    category: Category.GRADES_CLUB,
    level: Level.INTERMEDIAIRE,
  },
  {
    id: 'pg11',
    text: '🟢🟠 Ceinture orange-verte — Quelle est la traduction de "Ushiro Goshi" ?',
    options: ['Projection de hanche en soulevant', 'Projection de hanche par l\'arrière', 'Hanche balayée', 'Roue autour de la jambe'],
    correctIndex: 1,
    explanation: 'Ushiro Goshi = "projection de hanche par l\'arrière". Ushiro = arrière, Goshi = hanche. C\'est une contre-attaque : quand Uke tente une technique de hanche, Tori le soulève par l\'arrière.',
    category: Category.GRADES_CLUB,
    level: Level.INTERMEDIAIRE,
  },
  ...
  {
    id: 'pg12',
    text: '🟢 Ceinture verte — "Tomoe Nage" se traduit par :',
    options: ['Projection en arrière', 'Renversement dans l\'angle', 'Projection en cercle', 'Barrage extérieur en s\'enroulant'],
    correctIndex: 2,
    explanation: 'Tomoe Nage = "projection en cercle". Tomoe = cercle/tourbillon, Nage = projection. Tori place son pied dans le ventre d\'Uke et se laisse tomber en arrière pour le projeter en arc de cercle.',
    category: Category.GRADES_CLUB,
    level: Level.INTERMEDIAIRE,
  },
  {
    id: 'pg13',
    text: '🟢 Ceinture verte — "Utsuri Goshi" signifie :',
    options: ['Projection de hanche en contre', 'Grande hanche', 'Hanche pêchée en soulevant', 'Projection de hanche par l\'arrière'],
    correctIndex: 0,
    explanation: 'Utsuri Goshi = "projection de hanche en contre". C\'est une technique de contre : lorsqu\'Uke tente une projection de hanche, Tori change (Utsuri) de hanche pour contre-attaquer.',
    category: Category.GRADES_CLUB,
    level: Level.CONFIRME,
  },
  ...
  {
    id: 'pg14',
    text: '🔵 Ceinture bleue — "Tani Otoshi" se traduit par :',
    options: ['Enroulement latéral', 'Chute dans la vallée', 'Accrochage latéral', 'Projection en cercle sur le côté'],
    correctIndex: 1,
    explanation: 'Tani Otoshi = "chute dans la vallée". Tani = vallée, Otoshi = chute/renversement. Tori se laisse tomber sur le côté derrière Uke pour le projeter en arrière — c\'est une technique de sacrifice (Sutemi Waza).',
    category: Category.GRADES_CLUB,
    level: Level.CONFIRME,
  },
  {
    id: 'pg15',
    text: '🔵 Ceinture bleue — "Juji Gatame" désigne :',
    options: ['Un étranglement en triangle', 'Un contrôle par l\'épaule', 'Une clé en croix (extension du coude)', 'Une immobilisation arrière'],
    correctIndex: 2,
    explanation: 'Juji Gatame = "clé en croix". Juji = croix, Gatame = contrôle/clé. Tori bloque le bras d\'Uke en croix sur sa hanche et tire vers lui pour forcer l\'extension du coude — c\'est la première clé de bras du programme.',
    category: Category.GRADES_CLUB,
    level: Level.CONFIRME,
  },
  ...
  {
    id: 'pg16',
    text: '🟤 Ceinture marron — "Morote Gari" se traduit par :',
    options: ['Renversement du talon', 'Renversement dans l\'angle', 'Fauchage des deux jambes', 'Roue de la main'],
    correctIndex: 2,
    explanation: 'Morote Gari = "fauchage des deux jambes". Morote = les deux mains/les deux, Gari = fauchage. Tori saisit les deux jambes d\'Uke et le projette en arrière — technique classique Te Waza.',
    category: Category.GRADES_CLUB,
    level: Level.CONFIRME,
  },
  {
    id: 'pg17',
    text: '🟤 Ceinture marron — "Kibisu Gaeshi" signifie :',
    options: ['Renversement dans l\'angle', 'Retournement du talon', 'Projection par le cou', 'Clé en torsion'],
    correctIndex: 1,
    explanation: 'Kibisu Gaeshi = "retournement du talon". Kibisu = talon, Gaeshi = retournement/contre. Tori saisit le talon d\'Uke et le retourne — technique de jambe avec saisie basse.',
    category: Category.GRADES_CLUB,
    level: Level.CONFIRME,
  },
  {
    id: 'pg18',
    text: '🟤 Ceinture marron — "Ude Garami" désigne :',
    options: ['Une clé en extension du coude', 'Un étranglement d\'une main', 'Une clé en torsion du bras', 'Une immobilisation en travers'],
    correctIndex: 2,
    explanation: 'Ude Garami = "clé en torsion du bras". Ude = bras, Garami = entortiller/torsion. Tori enroule et tord le bras d\'Uke pour créer une pression sur l\'épaule et le coude — appelée aussi "clé de kimura".',
    category: Category.GRADES_CLUB,
    level: Level.CONFIRME,
  },
  {
    id: 'pg19',
    text: '🟤 Ceinture marron — Parmi ces étranglements, lequel signifie "étranglement à mains nues" ?',
    options: ['Kata Ha Jime', 'Okuri Eri Jime', 'Hadaka Jime', 'Kata Juji Jime'],
    correctIndex: 2,
    explanation: 'Hadaka Jime = "étranglement à mains nues" (ou "à corps nu"). Hadaka = nu/sans vêtement. Tori étouffe Uke par l\'arrière avec l\'avant-bras directement sur la trachée, sans saisir le judogi.',
    category: Category.GRADES_CLUB,
    level: Level.CONFIRME,
  },
  {
    id: 'pg20',
    text: '🟤 Ceinture marron — "Sankaku Jime" se traduit par :',
    options: ['Étranglement en croix', 'Étranglement en triangle', 'Clé en torsion', 'Contrôle en triangle'],
    correctIndex: 1,
    explanation: 'Sankaku Jime = "étranglement en triangle". Sankaku = triangle, Jime = étranglement. Tori forme un triangle avec ses jambes autour du cou et du bras d\'Uke pour l\'étrangler — aussi efficace depuis la garde.',
    category: Category.GRADES_CLUB,
    level: Level.CONFIRME,
  },
